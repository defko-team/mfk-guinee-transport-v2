...
class CustomerHomeOld extends StatefulWidget {
  final String? userId;
  final List<StationModel> locations;

  const CustomerHomeOld(
      {super.key, required this.userId, required this.locations});

  @override
  State<CustomerHomeOld> createState() => _CustomerHomeState();
}

class _CustomerHomeState extends State<CustomerHomeOld> {
